...
export const CITIES: { id: string; ar: string; en: string }[] = [
  ...
  { id: "hilla", ar: "بابل", en: "Babylon" },
  { id: "diwaniyah", ar: "الديوانية", en: "Diwaniyah" },
  { id: "nasiriyah", ar: "ذي قار", en: "Dhi Qar" },
  { id: "amarah", ar: "ميسان", en: "Maysan" },
  { id: "samawah", ar: "المثنى", en: "Muthanna" },
  { id: "kut", ar: "واسط", en: "Wasit" },
  { id: "baquba", ar: "ديالى", en: "Diyala" },
  { id: "ramadi", ar: "الأنبار", en: "Anbar" },
  { id: "tikrit", ar: "صلاح الدين", en: "Salah ad-Din" },
];
