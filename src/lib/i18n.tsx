...
export const dict = {
  ...
  surgical_guides_sub: {
    ar: "قوالب رقمية لتركيب الزرعة بدقة",
    en: "Digital templates for precise implant placement",
  },
  guide_systems: { ar: "الأنظمة المتوافقة", en: "Compatible systems" },
  search_guides_placeholder: {
    ar: "ابحث باسم الشركة أو نوع الدليل…",
    en: "Search by company or guide type…",
  },
